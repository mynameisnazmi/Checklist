<?php
	...
	$insert = mysql_query("UPDATE `form_checklist_line_5_resinsilo` SET `Status` = '$status', `Tanggal_Status` = '$tanggalcek' WHERE `form_checklist_line_5_resinsilo`.`Tanggal` = '$tanggal';");
	if(!$insert){
