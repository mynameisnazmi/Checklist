<?php
	...
	$insert = mysql_query("UPDATE `form_checklist_line_6_casting` SET `Status` = '$status', `Tanggal_Status` = '$tanggalcek' WHERE `form_checklist_line_6_casting`.`Tanggal` = '$tanggal';");
	if(!$insert){
