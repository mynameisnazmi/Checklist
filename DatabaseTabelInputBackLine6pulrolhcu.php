...
if(isset($_POST['submit'])){
	...
	$insert = mysql_query("UPDATE form_checklist_line_6_pullroll SET 
				...
				Pump_Heat_Cool_UI_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_6_pullroll SET
				...
				Pump_Flame_Treat_Top_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_6_pullroll SET
				...
				Pump_Corona_Bot_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_6_pullroll SET
				...
				Pump_Corona_Top_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_6_pullroll SET
				...
				Pump_Heat_Cool_UO_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_6_pullroll SET
				...
				Fan_Corona_Exh_Top_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_6_pullroll SET
				...
				Fan_Corona_Exh_Bot_Ket = '$ket[$j]' WHERE Tanggal = '$date';"); 

	if(!$insert){
		echo "<h1><script>alert('Form Checklist Line 6 Pull Roll HCU Tanggal ($date) Gagal Disimpan');</script></h1>";

echo "<h2><script>alert('Tidak Dapat Input Data Pada Tanggal Yang Sama');
		location.href='MainPageTab.php';</script></h2>";
	}
	else {
		include "WebTabelbacktoairsysline6.php";
	}						
}	
else{
	echo "Proses Salah";
