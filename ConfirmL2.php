...
<?php
	...
	if (isset($_POST['btn'])) {
		$sel = $_POST['perintah'];
		switch ($sel) {
			case '1': header("Location: ../checklist/Webtabelbacktoline2rawmaterial.php");break;
			case '2': header("Location: ../checklist/Webtabelbacktoline2ext.php");break;
			case '3': header("Location: ../checklist/Webtabelbacktoline2mdo.php");break;
			case '4': header("Location: ../checklist/Webtabelbacktoline2tdo.php");break;
			case '5': header("Location: ../checklist/Webtabelbacktoline2pullroll.php");break;
			case '6': header("Location: ../checklist/Webtabelbacktoline2winder.php");break;
