...
if(isset($_POST['submit'])){
	...
	$insert6 = mysql_query("INSERT INTO form_checklist_line_6_airsys VALUES('$cek6','',
	'','','','','','','','',
	'','','','','','','','',
	'','','','','','','','',
	'','','','','','','','',
	...
	");
	if(!$insert6){
		$insert5 = mysql_query("INSERT INTO form_checklist_line_6_airsys VALUES('$cek5','',
		'','','','','','','','',
		'','','','','','','','',
		'','','','','','','','',
		'','','','','','','','',
		...
		");
		if(!$insert5){
			$insert4 = mysql_query("INSERT INTO form_checklist_line_6_airsys VALUES('$cek4','',
			'','','','','','','','',
			'','','','','','','','',
			'','','','','','','','',
			'','','','','','','','',
			...
			");
			if(!$insert4){
				$insert3 = mysql_query("INSERT INTO form_checklist_line_6_airsys VALUES('$cek3','',
				'','','','','','','','',
				'','','','','','','','',
				'','','','','','','','',
				'','','','','','','','',
				...
				");
				if(!$insert3){						
					$insert2 = mysql_query("INSERT INTO form_checklist_line_6_airsys VALUES('$cek2','',
					'','','','','','','','',
					'','','','','','','','',
					'','','','','','','','',
					'','','','','','','','',
					...
					");
					if(!$insert2){	
						$insert1 = mysql_query("INSERT INTO form_checklist_line_6_airsys VALUES('$cek1','',
						'','','','','','','','',
						'','','','','','','','',
						'','','','','','','','',
						'','','','','','','','',
						...
						");
						if(!$insert1){
							$insert = mysql_query("INSERT INTO form_checklist_line_6_airsys VALUES
							('$tanggal','$nama',
							...
							");
							if(!$insert){
										echo "<h1><script>alert('Form Checklist Line 6 Airing System ($tgl) Gagal Disimpan');</script></h1>";
	echo "<h2><script>alert('Tidak Dapat Input Data Pada Tanggal Yang Sama');
		location.href='MainPageTab.php';</script></h2>";
							}
							else {
								include "WebTabelLine6Bigsilo.php";
							}
						}
						else{
							$insert = mysql_query("INSERT INTO form_checklist_line_6_airsys VALUES
