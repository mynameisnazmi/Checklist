<?php
	...
	$insert = mysql_query("UPDATE `form_checklist_line_4_resinsilo` SET `Status` = '$status', `Tanggal_Status` = '$tanggalcek' WHERE `form_checklist_line_4_resinsilo`.`Tanggal` = '$tanggal';");
if(!$insert){
