...
if(isset($_POST['submit'])){
	...
	$insert6 = mysql_query("INSERT INTO form_checklist_line_7_casting VALUES('$cek6','','','',
	'','','','','','','','',
	'','','','','','','','',
	'','','','','','','','',
	'','','','','','','','',
	...
	'','','','','','','','')
	");
	$insert5 = mysql_query("INSERT INTO form_checklist_line_7_casting VALUES('$cek5','','','',
	'','','','','','','','',
	'','','','','','','','',
	'','','','','','','','',
	'','','','','','','','',
	...
	'','','','','','','','')
	");
	$insert4 = mysql_query("INSERT INTO form_checklist_line_7_casting VALUES('$cek4','','','',
	'','','','','','','','',
	'','','','','','','','',
	'','','','','','','','',
	'','','','','','','','',
	...
	'','','','','','','','')
	");
	$insert3 = mysql_query("INSERT INTO form_checklist_line_7_casting VALUES('$cek3','','','',
	'','','','','','','','',
	'','','','','','','','',
	'','','','','','','','',
	'','','','','','','','',
	...
	'','','','','','','','')
	");
	$insert2 = mysql_query("INSERT INTO form_checklist_line_7_casting VALUES('$cek2','','','',
	'','','','','','','','',
	'','','','','','','','',
	'','','','','','','','',
	'','','','','','','','',
	...
	'','','','','','','','')
	");
	$insert1 = mysql_query("INSERT INTO form_checklist_line_7_casting VALUES('$cek1','','','',
	'','','','','','','','',
	'','','','','','','','',
	'','','','','','','','',
	'','','','','','','','',
	...
	'','','','','','','','')
	");
	$insert = mysql_query("INSERT INTO form_checklist_line_7_casting VALUES
	('$tanggal','$nama','','',
	...
	");
	if(!$insert){
	echo "<h1><script>alert('Form Checklist Line 7 Casting Tanggal ($tgl) Gagal Disimpan');</script></h1>";
	echo "<h2><script>alert('Tidak Dapat Input Data Pada Tanggal Yang Sama');
		location.href='MainPageTab.php';</script></h2>";
	}
	else {
		include "WebTabelLine7Ext.php";
	}						
}	
else{
	echo "Proses Salah";
