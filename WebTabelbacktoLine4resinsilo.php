...
<form method="POST" action="DatabaseTabelInputBackLine4resinsilo.php">
...
session_start();
	...
	$select = "SELECT * FROM form_checklist_line_4_resinsilo WHERE Tanggal = '$date'";
	...
	$arr = array("&nbsp;Material&nbsp;Dosing&nbsp;Unit&nbsp;(MDU&nbsp;Mixer)&nbsp;","Blower Transfer Material");
	$j=4;
	$i=1;
	while($i<=2)
	{
