...
if(isset($_POST['submit'])){
	...
	$insert = mysql_query("UPDATE form_checklist_line_7_bigsilo SET 
				...
				Bigbag_Blow_Stat_Fan1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_bigsilo SET
				...
				Bigbag_Rotary_Valve1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_bigsilo SET
				...
				Silo_Blow_Stat_Fan1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_bigsilo SET
				...
				Rotary_Valve1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_bigsilo SET
				...
				Rotary_Valve2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_bigsilo SET
				...
				Rotary_Valve3_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_bigsilo SET
				Bigbag_Blow_Stat_Fan2_VMDE = '$vmde[$j]',
				Bigbag_Blow_Stat_Fan2_VMNDEA = '$vmndea[$j]',
				Bigbag_Blow_Stat_Fan2_VMNDER = '$vmnder[$j]',
				Bigbag_Blow_Stat_Fan2_TempM = '$tempm[$j]',
				Bigbag_Blow_Stat_Fan2_ArusR = '$arusr[$j]',
				Bigbag_Blow_Stat_Fan2_ArusS = '$aruss[$j]',
				Bigbag_Blow_Stat_Fan2_ArusT = '$arust[$j]',
				Bigbag_Blow_Stat_Fan2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_bigsilo SET
				Rotary_Valve_1_VMDE = '$vmde[$j]',
				Rotary_Valve_1_VMNDEA = '$vmndea[$j]',
				Rotary_Valve_1_VMNDER = '$vmnder[$j]',
				Rotary_Valve_1_TempM = '$tempm[$j]',
				Rotary_Valve_1_ArusR = '$arusr[$j]',
				Rotary_Valve_1_ArusS = '$aruss[$j]',
				Rotary_Valve_1_ArusT = '$arust[$j]',
				Rotary_Valve_1_Ket = '$ket[$j]'
				 WHERE Tanggal = '$date';"); 

	if(!$insert){
		echo "<h1><script>alert('Form Checklist Line 7 Big Silo Storage Tanggal ($date) Gagal Disimpan');</script></h1>";

echo "<h2><script>alert('Tidak Dapat Input Data Pada Tanggal Yang Sama');
		location.href='MainPageTab.php';</script></h2>";
	}
	else {
		include "WebTabelbacktomdoline7.php";
	}						
}	
else{
	echo "Proses Salah";
