...
if(isset($_POST['submit'])){
	...
	$insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET 
				...
				Cooling1_Fan1_Top1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling1_Fan1_Top2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling1_Fan2_Top1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling1_Fan2_Top2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling1_Fan1_Bot1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling1_Fan1_Bot2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling1_Fan2_Bot1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling1_Fan2_Bot2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling2_Fan1_Top1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling2_Fan1_Top2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling2_Fan2_Top1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling2_Fan2_Top2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling2_Fan1_Bot1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling2_Fan1_Bot2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling2_Fan2_Bot1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling2_Fan2_Bot2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling3_Fan1_Top1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling3_Fan1_Top2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling3_Fan2_Top1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling3_Fan2_Top2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling3_Fan1_Bot1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling3_Fan1_Bot2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling3_Fan2_Bot1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling3_Fan2_Bot2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling4_Fan1_Top1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling4_Fan1_Top2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling4_Fan2_Top1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling4_Fan2_Top2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling4_Fan1_Bot1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling4_Fan1_Bot2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling4_Fan2_Bot1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling4_Fan2_Bot2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling5_Fan1_Top1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling5_Fan1_Top2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling5_Fan2_Top1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling5_Fan2_Top2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling5_Fan1_Bot1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling5_Fan1_Bot2_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling5_Fan2_Bot1_Ket = '$ket[$j]' WHERE Tanggal = '$date';");   $j++; $insert = mysql_query("UPDATE form_checklist_line_7_tdoas SET
				...
				Cooling5_Fan2_Bot2_Ket = '$ket[$j]'
		WHERE Tanggal = '$date';"); 

	if(!$insert){
		echo "<h1><script>alert('Form Checklist Line 7 TDO Air Shower Tanggal ($date) Gagal Disimpan');</script></h1>";

echo "<h2><script>alert('Tidak Dapat Input Data Pada Tanggal Yang Sama');
		location.href='MainPageTab.php';</script></h2>";
	}
	else {
		include "WebTabelbacktopulrolhculine7.php";
	}						
}	
else{
	echo "Proses Salah";
