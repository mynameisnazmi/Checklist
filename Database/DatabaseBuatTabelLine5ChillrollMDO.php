<?php
	...
	if($cek)
	{
		...
		$tabel = 'CREATE TABLE form_checklist_line_5_chillrollmdo( '.
				...
				'Chill_Cool_Fan_Blow_VMDE FLOAT(30) NOT NULL, '.
				'Chill_Cool_Fan_Blow_VMNDEA FLOAT(30) NOT NULL, '.
				'Chill_Cool_Fan_Blow_VMNDER FLOAT(30) NOT NULL, '.
				'Chill_Cool_Fan_Blow_TempM FLOAT(30) NOT NULL, '.
				'Chill_Cool_Fan_Blow_ArusR FLOAT(30) NOT NULL, '.
				'Chill_Cool_Fan_Blow_ArusS FLOAT(30) NOT NULL, '.
				'Chill_Cool_Fan_Blow_ArusT FLOAT(30) NOT NULL, '.
				'Chill_Cool_Fan_Blow_Ket VARCHAR(50) NOT NULL, '.
				...
				'DC_Aux_Winder_VMDE FLOAT(30) NOT NULL, '.
				'DC_Aux_Winder_VMNDEA FLOAT(30) NOT NULL, '.
				'DC_Aux_Winder_VMNDER FLOAT(30) NOT NULL, '.
				'DC_Aux_Winder_TempM FLOAT(30) NOT NULL, '.
				'DC_Aux_Winder_ArusR FLOAT(30) NOT NULL, '.
				'DC_Aux_Winder_ArusS FLOAT(30) NOT NULL, '.
				'DC_Aux_Winder_ArusT FLOAT(30) NOT NULL, '.
				'DC_Aux_Winder_Ket VARCHAR(50) NOT NULL, '.
				'primary key ( Tanggal ))';		
