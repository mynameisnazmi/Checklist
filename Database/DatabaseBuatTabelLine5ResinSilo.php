<?php
	...
	if($cek)
	{
		...
		$tabel = 'CREATE TABLE form_checklist_line_5_resinsilo( '.
				...
				'Res_Trf_Blw_Fed_Trc_VMNDEA FLOAT(30) NOT NULL, '.
				'Res_Trf_Blw_Fed_Trc_VMNDER FLOAT(30) NOT NULL, '.
				'Res_Trf_Blw_Fed_Trc_TempM FLOAT(30) NOT NULL, '.
				'Res_Trf_Blw_Fed_Trc_ArusR FLOAT(30) NOT NULL, '.
				'Res_Trf_Blw_Fed_Trc_ArusS FLOAT(30) NOT NULL, '.
				'Res_Trf_Blw_Fed_Trc_ArusT FLOAT(30) NOT NULL, '.
				'Res_Trf_Blw_Fed_Trc_Ket VARCHAR(50) NOT NULL, '.
