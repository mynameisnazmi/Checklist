<?php
	...
	if($cek)
	{
		...
		$tabel = 'CREATE TABLE form_checklist_line_7_bigsilo( '.
				...
				'Bigbag_Blow_Stat_Fan2_VMDE FLOAT(30) NOT NULL, '.
				'Bigbag_Blow_Stat_Fan2_VMNDEA FLOAT(30) NOT NULL, '.
				'Bigbag_Blow_Stat_Fan2_VMNDER FLOAT(30) NOT NULL, '.
				'Bigbag_Blow_Stat_Fan2_TempM FLOAT(30) NOT NULL, '.
				'Bigbag_Blow_Stat_Fan2_ArusR FLOAT(30) NOT NULL, '.
				'Bigbag_Blow_Stat_Fan2_ArusS FLOAT(30) NOT NULL, '.
				'Bigbag_Blow_Stat_Fan2_ArusT FLOAT(30) NOT NULL, '.
				'Bigbag_Blow_Stat_Fan2_Ket VARCHAR(50) NOT NULL, '.
				'Rotary_Valve_1_VMDE FLOAT(30) NOT NULL, '.
				'Rotary_Valve_1_VMNDEA FLOAT(30) NOT NULL, '.
				'Rotary_Valve_1_VMNDER FLOAT(30) NOT NULL, '.
				'Rotary_Valve_1_TempM FLOAT(30) NOT NULL, '.
				'Rotary_Valve_1_ArusR FLOAT(30) NOT NULL, '.
				'Rotary_Valve_1_ArusS FLOAT(30) NOT NULL, '.
				'Rotary_Valve_1_ArusT FLOAT(30) NOT NULL, '.
				'Rotary_Valve_1_Ket VARCHAR(50) NOT NULL, '.
				'primary key ( Tanggal ))';		
