...
<form method="POST" action="DatabaseTabelInputBackLine7mdo.php">
...
<?php session_start();
	...
	$select = "SELECT * FROM form_checklist_line_7_mdo WHERE Tanggal = '$date'";
	...
	$arr = array("&nbsp;Drawing&nbsp;1&nbsp;(+SR13=331M5&nbsp;-&nbsp;M015)&nbsp;", 
		"Drawing 2 (+SR13=331M6-M015)", 
		"Drawing 3 (+SR13=331M7-M015)",
		"Drawing 4 (+SR13=331M8-M015)", 
		"Drawing 5 (+SR13=331M9-M015)", 
		"Drawing 6 (+SR13=331MA-M015)");
	$j=2;
	$i=1;
	while($i<=6)
	{
